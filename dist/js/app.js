(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu-mob-header__burger")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu-mob-header__burger")) {
                    bodyLockToggle();
            ...
            if (catalogTitles) {
                catalogTitles.forEach((title => {
                    title.addEventListener("click", (e => {
                        title.nextElementSibling.classList.add("_catalog-open");
                        bodyLock();
                    }));
                }));
                catalogArrows.forEach((arrow => {
                    arrow.addEventListener("click", (function(e) {
                        catalogItems.forEach((el => {
                            el.classList.remove("_catalog-open");
                        }));
                        bodyUnlock();
                    }));
                }));
        ...
        function filter() {
            ...
            if (filterBlockIcon) {
                ...
                const filterBlockClear = document.querySelector(".filter-block-mob__clear");
        ...
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                this.selectClasses = {
                    ...
                    classSelectContent: "select__content _icon-arrow",
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (handle) priceEnd.value = value; else priceStart.value = value;
                }));
            }
        }
        rangeInit();
        ...
        if (document.querySelector(".product-slider-top")) new core(".product-slider-top", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        document.querySelectorAll(".product").forEach((n => {
            new core(n.querySelector(".product-slider-tabs"), {
            ...
            new core(n.querySelector(".product-slider"), {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        if (document.querySelector(".top-tabs-system-block__slider")) new core(".top-tabs-system-block__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        function scrollBrands() {
            ...
            if (scrollBrand) {
                ...
                scrollBrand.addEventListener("mousemove", (function(e) {
                    if (drag) this.scrollLeft = left - (e.pageX - coorX) * speed;
                }));
            }
        }
        scrollBrands();
        ...
        function catalogPc() {
            ...
            if (catalogPcItems) if (catalogPcItems.length > 0) catalogPcItems.forEach((function(e) {
        ...
        if (cartBlockInputFile) cartBlockInputFile.forEach((el => {
            el.addEventListener("change", (event => {
                var file = event.target.files;
                for (var f, i = 0; f = file[i]; i++) {
                    ...
                    reader.onload = function(theFile) {
                        return function cartBlockFileMask(e) {
                            ...
                            span.innerHTML = [ '<div class="photo-checkout__input-file-remove _icon-close">Удалить</div>' + '<img class="thumb" title="', escape(theFile.name), '" src="', e.target.result, '" />' ].join("");
                    ...
                    if (inputRemove) inputRemove.forEach((btn => {
        ...
        if (tabFilterTitles) tabFilterTitles.forEach((title => {
            title.addEventListener("click", (function(e) {
                tabFilterTitles.forEach((el => {
        ...
        function search() {
            ...
            if (searchInput) {
                ...
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".bottom-header__input") && !target.closest(".bottom-header__inputs")) document.documentElement.classList.remove("search-open");
                }));
            }
        }
        search();
